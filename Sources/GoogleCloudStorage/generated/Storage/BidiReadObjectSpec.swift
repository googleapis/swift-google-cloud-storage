...
public struct BidiReadObjectSpec: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BidiReadObjectSpec`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BidiReadObjectSpec().with { $0.bucket = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.v2.BidiReadObjectSpec"
  }
