  ...
  Sendable
{
  ...
  /// Initialize a new instance of `CancelResumableWriteRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CancelResumableWriteRequest().with { $0.uploadId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.v2.CancelResumableWriteRequest"
  }
