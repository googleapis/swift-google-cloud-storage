  ...
  Sendable
{
  ...
  public var objectDataRanges: [ObjectRangeData] = []
  ...
  /// Initialize a new instance of `BidiReadObjectResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BidiReadObjectResponse().with { $0.objectDataRanges = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.v2.BidiReadObjectResponse"
  }
